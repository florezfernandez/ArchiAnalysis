...
public class CatalogType extends AbstractArchiAnalysisFunction implements IChainableArchiFunction{
	...
	public String getDescription() {
		return "This function returns a catalog of the elements in the model of a specific class.\n"
				+ "It has to have a property specified in the input parameters\n"
				+ "Input parameters:\n"
	...
	public String[] inNames() {
		return new String[]{"File path:","Catalog class", "Type"};
	}
