...
public class GetCatalogElementResult implements ITableResult, Serializable{
	 ...
	 * @param line
	 */
	public GetCatalogElementResult(WElement element1, List<WElement> orderedElements2){
