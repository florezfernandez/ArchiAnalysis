...
public class RaciMatrix extends AbstractArchiAnalysisFunction implements IChainableArchiFunction{
	private List<RaciMatrixResult> listResults;
	...
	public Object validateModel(ValidationResponse validationResponse) throws Exception{
		RaciMatrixSWT mSWT=new RaciMatrixSWT(Display.getCurrent());
		mSWT.displayWidget();
		...
		listResults = new ArrayList<RaciMatrixResult>();
	...
	public Object executeFunction() throws Exception {
		...
		for(WElement element:elements){
			RaciMatrixResult result=new RaciMatrixResult(element, orderedElements2);
